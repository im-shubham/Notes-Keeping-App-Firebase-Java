...
import static com.shubhamvig.notes.Utils.SignIn.verifyEnteredEmail;
import static com.shubhamvig.notes.Utils.SignIn.verifyEnteredPass;

public class SettingsActivity extends AppCompatActivity {

    private ImageButton goBack, twitter ,linkedin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twitter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/itz_ishubham"));
        ...
        linkedin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.linkedin.com/in/shubhamvig/"));
                startActivity(intent);
            }
        });
